...
import Search from "../components/Search"; // Ajusta la ruta según tu estructura de carpetas

// Define la interfaz para los autos
interface Auto {
  _id: string;
  marca: string;
  region: string;
...
export default function CatalogoClient({ initialAutos }: CatalogoClientProps) {
  ...
  // Fetch dinámico basado en los filtros
  useEffect(() => {
